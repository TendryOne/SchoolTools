    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($_FILES['ProfilePicture']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($fileExtension, $allowedExtensions)) {
                ...
                if (!empty($currentUserProf['ProfilePicture'])) {
                    $oldFilePath = $uploadDirectory . basename($currentUserProf['ProfilePicture']);
                ...
                if (move_uploaded_file($_FILES['ProfilePicture']['tmp_name'], $destinationPath)) {
                    $profController->UploadProfile($dest, $currentUserProf['id_prof']);
    ...
    <div class="profile-container">
        ...
        <form action="profile.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="custom-file-input">
                ...
                <label for="myFile" id="fileLabel" style="background-image:url('<?= $currentUserProf['ProfilePicture'] ?>');">Modifier ma Photo de profil</label>
                <p id="fileName"></p>
                <?php if ($error['image']) : ?>
                    <p><?= $error['image'] ?></p>
                <?php endif ?>
            ...
            <ul class="information-container">
                <div class="info-content">
                    <span>Nom :</span>
                    <li> <?= $currentUserProf['name'] ?></li>
                </div>
                <div class="info-content">
                    <span>Prenom :</span>
                    <li><?= $currentUserProf['firstname'] ?></li>
                </div>
                <div class="info-content">
                    <span>Votre email :</span>
                    <li><?= $currentUserProf['email'] ?></li>
                </div>
                <div class="info-content">
