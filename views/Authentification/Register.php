...
<head>
    ...
    <title>Inscription | GeniusGate</title>
</head>
<?php
            ...
            <div class="form-group">
                <div class="form-list">
                    <select name="role" id="role">
                        <option value="Default" disabled <?= !$role || $role === 'Default' ? 'selected' : '' ?>>~~~ Veuillez choisr un role ~~~</option>
                    ...
                    <?php if ($error['role']) : ?>
                        <p class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= $error['role'] ?> </p>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
